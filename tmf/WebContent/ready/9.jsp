...
<li><a href="shoppingCart.jsp">Cart</a></li>
    ...
    <div class="nine">
  	<div style="text-align:left;">
        <br><br><br><br>
      <img src="../image/하트하트/1.jpg" alt="8" width="500" height="500"></img>
      <div class="detail">
          <h3>상품상세정보</h3><br><br>
          <p><b>Product Info</b></p>
          <p>볼드함과 페미닌함을 모두 갖춘 화려한 하트 드롭 귀걸이</p>
...
<th scope="row"><span>상품명</span></th>
                            <td><span>하트하트 귀걸이</span></td>
                        </tr>
<tr>
<th scope="row"><span style="font-size:14px;color:#e51623;font-weight:bold;">판매가</span></th>
                            <td><span style="font-size:14px;color:#e51623;font-weight:bold;"><strong id="span_product_price_text">14,000원 </strong><input id="product_price" name="product_price" value="" type="hidden"  /></span></td>
                        </tr>
<tr>
...
<form action="cart.jsp" method="POST">
					<input type="hidden" name="e_name" value="하트하트">
