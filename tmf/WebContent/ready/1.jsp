...
<li><a href="../custom/Choice_cus.jsp">HAND-MADE</a></li>
			...
			<div style="text-align:left;">
				<br><br><br><br>
				<img src="../image/샴페인골드/1.jpg" alt="1" width="500" height="500"></img>
				<div class="detail">
					<h3>상품상세정보</h3><br><br>
					<p><b>Product Info</b></p>
					<p>수공예 악세사리의 매력인 흔치않은 디자인과 고급스러움을 모두 갖춘 샴페인 골드 귀걸이</p>
					<p><b>Exchange &amp; Refund</b></p>
					<p>화면과 실제 상품에 미세한 색상 차이가 있을 수 있으며 디자인의 위치가 다를 수 있습니다.</p>
					<p>위 사항은 교환 및 환불이 불가하니 이 점 유의해 구매 부탁드립니다.</p>
				</div>
				<table class="type03">
					...
					<tbody>
						<tr>
							...
							<td><span>샴페인골드 귀걸이</span></td>
						</tr>
						<tr>
							<th scope="row"><span style="font-size:14px;color:#e51623;font-weight:bold;">판매가</span></th>
							<td><span style="font-size:14px;color:#e51623;font-weight:bold;"><strong id="span_product_price_text">13,000원 </strong><input id="product_price" name="product_price" value="" type="hidden" /></span></td>
						</tr>
						<tr>
							<th scope="row"><span style="font-size:12px;color:#474747;">배송비</span></th>
							<td><span style="font-size:12px;color:#474747;"><span class="delv_price_B"><input id="delivery_cost_prepaid" name="delivery_cost_prepaid" value=" " type="hidden" /><strong>2,500원</strong> (50,000원 이상 구매 시 무료)</span>
									<div class="delv_price_C" style="display:none">해외배송비</div>
								</span></td>
						</tr>
					</tbody>
				</table>
				...
				<table class="type02">
					...
					<tbody>
						<tr>
							<th scope="row">색상</th>
							<td><select option_product_no="1317" option_select_element="ec-option-select-finder" option_sort_no="1" option_type="T" item_listing_type="S" option_title="색상" product_option_area="product_option_1317_0" name="option1" id="product_option_id1" class="ProductOption0" option_style="select" required="true">
									<option value="*" link_image="">
										- [필수] 색상 선택 -</option>
									<option value="**" link_image="">-------------------</option>
									<option value="골드[구매율1위]" link_image="">골드[구매율1위]</option>
									<option value="실버" link_image="">실버</option>
									<option value="핑크(NEW)" link_image="">핑크(NEW)</option>
								</select>
								<p class="value"></p>
							</td>
						</tr>
						<tr>
							<th scope="row">옵션</th>
							<td><select option_product_no="1317" option_select_element="ec-option-select-finder" option_sort_no="2" option_type="T" item_listing_type="S" option_title="옵션" product_option_area="product_option_1317_0" name="option2" id="product_option_id2" class="ProductOption0" option_style="select" required="true">
									<option value="*" link_image="">
										- [필수] 옵션 선택 -</option>
									<option value="**" link_image="">-------------------</option>
									<option value="귀걸이" disabled="disabled" link_image="">귀걸이</option>
									<option value="귀찌" disabled="disabled" link_image="">귀찌</option>
								</select>
								<p class="value"></p>
							</td>
						</tr>
				...
				<form action="cart.jsp" method="POST">
					<input type="hidden" name="e_name" value="샴페인골드">
