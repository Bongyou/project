...
<li><a href="shoppingCart.jsp">Cart</a></li>
    ...
    <div class="one">
  	<div style="text-align:left;">
        <br><br><br><br>
      <img src="../image/써클태슬/1.jpg" alt="1" width="500" height="500"></img>
      <div class="detail">
          <h3>상품상세정보</h3><br><br>
          <p><b>Product Info</b></p>
          <p>골드링에 파란색 태슬을 달아 휴양지의 기분을 느낄 수 있는 귀걸이</p>
...
<form action="cart.jsp" method="POST">
					<input type="hidden" name="e_name" value="써클태슬">
