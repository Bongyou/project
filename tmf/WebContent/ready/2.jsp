...
<li><a href="shoppingCart.jsp">Cart</a></li>
		...
		<div class="two">
			<div style="text-align:left;">
				<br><br><br><br>
				<img src="../image/크리스탈물방울/1.jpg" alt="2" width="500" height="500"></img>
				<div class="detail">
					<h3>상품상세정보</h3><br><br>
					<p><b>Product Info</b></p>
					<p>어느 코디에나 다 잘어울리는 심플한 디자인의 귀걸이</p>
				...
				<table class="type03">
					...
					<tbody>
						<tr>
							...
							<td><span>크리스탈물방울링귀걸이</span></td>
						</tr>
						<tr>
							<th scope="row"><span style="font-size:14px;color:#e51623;font-weight:bold;">판매가</span></th>
							<td><span style="font-size:14px;color:#e51623;font-weight:bold;"><strong id="span_product_price_text">9,000원 </strong><input id="product_price" name="product_price" value="" type="hidden" /></span></td>
						</tr>
						<tr>
...
<tr>
			...
			<tr>
				...
				<form action="cart.jsp" method="POST">
					<input type="hidden" name="e_name" value="크리스탈물방울">
