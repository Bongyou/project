...
try{
	...
	String sql="select * from earring order by date asc limit 9";
	ps=conn.prepareStatement(sql);
	rs=ps.executeQuery();
	while(rs.next()){
		sale[i]=rs.getString(2);
		price[i]=rs.getInt(3);
		i++;
	}
}catch(Exception e){
...
%>
  <div class="content">
    <p>Sale</p>
    <div class="product">
  <a href="16.jsp"><img src="../image/<%=sale[0] %>/2.jpg"></a>
  <div class="pinfo">
    <pre><b>
    <%=sale[0] %> 귀걸이
<%=price[0] %> 원</b></pre>
...
<div class="product">
<a href="1.jsp"><img src="../image/<%=sale[1] %>/2.jpg"></a>
<div class="pinfo">
<pre><b>
<%=sale[1] %> 귀걸이
<%=price[1] %> 원</b></pre>
...
<div class="product">
<a href="10.jsp"><img src="../image/<%=sale[2] %>/3.jpg"></a>
<div class="pinfo">
<pre><b>
<%=sale[2] %> 귀걸이
<%=price[2] %> 원</b></pre>
  ...
  <br/>
  <div class="product">
<a href="6.jsp"><img src="../image/<%=sale[3] %>/2.jpg"></a>
<div class="pinfo">
  <pre><b>
<%=sale[3] %> 귀걸이
<%=price[3] %> 원</b></pre>
...
<div class="product">
<a href="12.jsp"><img src="../image/<%=sale[4] %>/3.jpg"></a>
<div class="pinfo">
<pre><b>
<%=sale[4] %> 귀걸이
<%=price[4] %> 원</b></pre>
...
<div class="product">
<a href="5.jsp"><img src="../image/<%=sale[5] %>/2.jpg"></a>
<div class="pinfo">
<pre><b>
<%=sale[5] %> 귀걸이
<%=price[5] %> 원</b></pre>
...
<br/>
<div class="product">
<a href="4.jsp"><img src="../image/<%=sale[6] %>/1.jpg"></a>
<div class="pinfo">
<pre><b>
<%=sale[6] %> 귀걸이
<%=price[6] %> 원</b></pre>
...
<div class="product">
<a href="3.jsp"><img src="../image/<%=sale[7] %>/2.jpg"></a>
<div class="pinfo">
<pre><b>
<%=sale[7] %> 귀걸이
<%=price[7] %> 원</b></pre>
...
<div class="product">
<a href="13.jsp"><img src="../image/<%=sale[8] %>/2.jpg"></a>
<div class="pinfo">
<pre><b>
<%=sale[8] %> 귀걸이
<%=price[8] %> 원</b></pre>
