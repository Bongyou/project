...
<meta http-equiv="Content-Type" content="text/html; charset=EUC-KR">
	...
	String nm2=(String)request.getParameter("nm2");
	int in_num=Integer.parseInt(nm2);
	...
	try{
		...
		String sql="select e_price from earring where e_name='"+e_name+"'";
    ...
    %>
        ...
        <form action="orderResult.jsp" method="POST" name="order">
        <div class="text-center">
	        <input type="hidden" name="e_name" value="<%=e_name%>">
	        <input type="hidden" name="c_name" value="<%=c_name%>">
	        <input type="hidden" name="date" value="<%=date%>">
	        <input type="hidden" name="nm2" value="<%=nm2%>">
        </div>
        <br><br>
        <center>
	        <div class="text-center">
