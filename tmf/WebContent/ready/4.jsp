...
<li><a href="shoppingCart.jsp">Cart</a></li>
    ...
    <div class="four">
  	<div style="text-align:left;">
        <br><br><br><br>
      <img src="../image/블랙다이아/1.jpg" alt="4" width="500" height="500"></img>
      <div class="detail">
          <h3>상품상세정보</h3><br><br>
          <p><b>Product Info</b></p>
          <p> 앤틱한 팬던트에서 볼수있는 은은한 세피아 색상이 매력적이에요🙌</p><br>
...
<form action="cart.jsp" method="POST">
					<input type="hidden" name="e_name" value="블랙다이아">
