...
<li><a href="shoppingCart.jsp">Cart</a></li>
    ...
    <div class="one">
  	<div style="text-align:left;">
        <br><br><br><br>
      <img src="../image/화이트스노우태슬/1.jpg" alt="1" width="500" height="500"></img>
      <div class="detail">
          <h3>상품상세정보</h3><br><br>
          <p><b>Product Info</b></p>
          <p>영롱한 하얀색 큐빅에 골드링을 매치하여 고급스러움을 주고 아래 태슬을 달아 겨울에도 어울리는 귀걸이</p>
...
<th scope="row"><span>상품명</span></th>
                            <td><span>화이트스노우태슬 귀걸이</span></td>
                        </tr>
<tr>
<th scope="row"><span style="font-size:14px;color:#e51623;font-weight:bold;">판매가</span></th>
                            <td><span style="font-size:14px;color:#e51623;font-weight:bold;"><strong id="span_product_price_text">12,000원 </strong><input id="product_price" name="product_price" value="" type="hidden"  /></span></td>
                        </tr>
<tr>
...
<form action="cart.jsp" method="POST">
					<input type="hidden" name="e_name" value="화이트스노우태슬">
