...
<li><a href="shoppingCart.jsp">Cart</a></li>
    ...
    <div class="one">
  	<div style="text-align:left;">
        <br><br><br><br>
      <img src="../image/진주드롭/1.jpg" alt="1" width="500" height="500"></img>
      <div class="detail">
          <h3>상품상세정보</h3><br><br>
          <p><b>Product Info</b></p>
          <p>진주큐빅에 진주를 연달아 매치해 우아하면서도 고급스러운 느낌을 줄 수 있는 귀걸이</p>
...
<form action="cart.jsp" method="POST">
					<input type="hidden" name="e_name" value="진주드롭">
