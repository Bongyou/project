...
<li><a href="shoppingCart.jsp">Cart</a></li>
    ...
    <div class="three">
  	<div style="text-align:left;">
        <br><br><br><br>
      <img src="../image/블루문스톤/1.jpg" alt="3" width="500" height="500"></img>
      <div class="detail">
          <h3>상품상세정보</h3><br><br>
          <p><b>Product Info</b></p>
          <p>달에서 나오는 빛과 닮은 천연 블루 문스톤 귀걸이</p>
...
<form action="cart.jsp" method="POST">
					<input type="hidden" name="e_name" value="블루문스톤">
