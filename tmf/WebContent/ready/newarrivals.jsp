...
try{
	...
	String sql="select * from earring order by date desc limit 9";
	ps=conn.prepareStatement(sql);
	rs=ps.executeQuery();
	while(rs.next()){
		newitem[i]=rs.getString(2);
		price[i]=rs.getInt(3);
		i++;
	}
}catch(Exception e){
...
%>
  <div class="content">
    <p>New Arrivals</p>
    <div class="product">
  <a href="15.jsp"><img src="../image/<%=newitem[0] %>/1.jpg"></a>
  <div class="pinfo">
    <pre><b>
    <%=newitem[0] %> 귀걸이
<%=price[0] %> 원</b></pre>
...
<div class="product">
<a href="14.jsp"><img src="../image/<%=newitem[1] %>/1.jpg"></a>
<div class="pinfo">
<pre><b>
<%=newitem[1] %> 귀걸이
<%=price[1] %> 원</b></pre>
...
<div class="product">
<a href="9.jsp"><img src="../image/<%=newitem[2] %>/1.jpg"></a>
<div class="pinfo">
<pre><b>
<%=newitem[2] %> 귀걸이
<%=price[2] %> 원</b></pre>
  ...
  <br/>
  <div class="product">
<a href="7.jsp"><img src="../image/<%=newitem[3] %>/1.jpg"></a>
<div class="pinfo">
  <pre><b>
<%=newitem[3] %> 귀걸이
<%=price[3] %> 원</b></pre>
...
<div class="product">
<a href="2.jsp"><img src="../image/<%=newitem[4] %>/1.jpg"></a>
<div class="pinfo">
<pre><b>
<%=newitem[4] %> 귀걸이
<%=price[4] %> 원</b></pre>
...
<div class="product">
<a href="8.jsp"><img src="../image/<%=newitem[5] %>/1.jpg"></a>
<div class="pinfo">
<pre><b>
<%=newitem[5] %> 귀걸이
<%=price[5] %> 원</b></pre>
...
<br/>
<div class="product">
<a href="13.jsp"><img src="../image/<%=newitem[6] %>/1.jpg"></a>
<div class="pinfo">
<pre><b>
<%=newitem[6] %> 귀걸이
<%=price[6] %> 원</b></pre>
...
<div class="product">
<a href="3.jsp"><img src="../image/<%=newitem[7] %>/1.jpg"></a>
<div class="pinfo">
<pre><b>
<%=newitem[7] %> 귀걸이
<%=price[7] %> 원</b></pre>
...
<div class="product">
<a href="5.jsp"><img src="../image/<%=newitem[8] %>/3.jpg"></a>
<div class="pinfo">
<pre><b>
<%=newitem[8] %> 귀걸이
<%=price[8] %> 원</b></pre>
