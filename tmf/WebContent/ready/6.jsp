...
<li><a href="shoppingCart.jsp">Cart</a></li>
    ...
    <div class="six">
  	<div style="text-align:left;">
        <br><br><br><br>
      <img src="../image/라벤더하트/1.jpg" alt="6" width="500" height="500"></img>
      <div class="detail">
          <h3>상품상세정보</h3><br><br>
          <p><b>Product Info</b></p>
          <p>블링블링한 핑크색 하트 큐빅으로 귀여움을 어필할 수 있는 귀걸이</p>
...
<th scope="row"><span>상품명</span></th>
                            <td><span>라벤더 하트 귀걸이</span></td>
                        </tr>
<tr>
<th scope="row"><span style="font-size:14px;color:#e51623;font-weight:bold;">판매가</span></th>
                            <td><span style="font-size:14px;color:#e51623;font-weight:bold;"><strong id="span_product_price_text">10,000원 </strong><input id="product_price" name="product_price" value="" type="hidden"  /></span></td>
                        </tr>
<tr>
...
<form action="cart.jsp" method="POST">
					<input type="hidden" name="e_name" value="라벤더하트">
