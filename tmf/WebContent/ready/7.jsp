...
<li><a href="shoppingCart.jsp">Cart</a></li>
    ...
    <div class="seven">
  	<div style="text-align:left;">
        <br><br><br><br>
      <img src="../image/스노우샹들리에/1.jpg" alt="7" width="500" height="500"></img>
      <div class="detail">
          <h3>상품상세정보</h3><br><br>
          <p><b>Product Info</b></p>
          <p>날씨가 추운 겨울에 포인트를 줄 수 있는 샹들리에를 닮은 귀걸이</p>
...
<form action="cart.jsp" method="POST">
					<input type="hidden" name="e_name" value="스노우샹들리에">
