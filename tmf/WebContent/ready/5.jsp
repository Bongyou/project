...
<li><a href="shoppingCart.jsp">Cart</a></li>
    ...
    <div class="five">
  	<div style="text-align:left;">
        <br><br><br><br>
      <img src="../image/라운드골드/1.jpg" alt="5" width="500" height="500"></img>
      <div class="detail">
          <h3>상품상세정보</h3><br><br>
          <p><b>Product Info</b></p>
          <p>따뜻한 느낌을 주는 봄에 어울리는 화려한 라운드골드드롭 귀걸이</p>
...
<form action="cart.jsp" method="POST">
					<input type="hidden" name="e_name" value="라운드골드">
