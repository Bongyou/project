	...
	<script type="text/javascript">
		...
		function check(){
			...
			if(num1==1&num2==1)
				...
				alert("개인정보 수집 및 이용 약관에 동의해야합니다.");
...
<li><a href="../custom/Choice_cus.jsp">HAND-MADE</a></li>
	...
	<div class="text-center">
		<span type="padding-left: 160px">이용약관 동의</span>
		<br>
		<hr>
		<br>
...
이 약관은 TMF 회사(전자상거래 사업자)가 운영하는 TMF 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.

※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
①“몰” 이란  치즈솔트  회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
부 칙(시행일) 이 약관은 2013년 2월 26일부터 시행합니다.
		</textarea>
		<br>
		이용약관에 동의하십니까? <input type="checkbox" name="req1"> 동의함
	</div>
	<br>
	<div class="text-center">
		<span type="padding-left:160px">개인정보 수집 및 이용 동의</span>
		<br>
		<hr>
		<br>
		<textarea rows="20" cols="150">
...
회사는 개인정보 수집 및 이용목적이 달성된 후에는 예외 없이 해당 정보를 지체 없이 파기합니다.
		...
		<br>
		개인정보 수집 및 이용에 동의하십니까? <input type="checkbox" name="req2"> 동의함
	</div>
	<br>
	<div class="text-center">
		<input type="button" value="동의" onclick="check()">&nbsp;&nbsp;
		<input type="button" value="동의하지않음" onclick="n_check()">
	</div>
	</form>
	<br>
</body>
