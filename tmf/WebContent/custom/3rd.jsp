...
<header>
        <script>
            ...
            function ch2(){
                ...
                if(second.value=='1'){
					second.style.boxShadow="0 0 10px 0 #FF4646";
            ...
            function ch3(){
                ...
                if(third.value=='1'){
					third.style.boxShadow="0 0 10px 0 #FF4646";
					second.style.boxShadow="none";
					first.style.boxShadow="none";
				}
            }
			...
			function check_pearl(i){
				...
				var pa2=document.getElementById('p_id_2');
				var pa3=document.getElementById('p_id_3');
                ...
                if(f=='1'){
                    ...
                    second.style.backgroundImage="url('../parts/pearl"+i+".png')";
                    pa2.value=2030+i;
                }
                else if(t=='1'){
                   third.style.backgroundImage="url('../parts/pearl"+i+".png')";
                   pa3.value=2030+i;
                }
            }
			...
			function check_circle(i){
                ...
                if(f=='1'){
                    ...
                    second.style.backgroundImage="url('../parts/circle"+i+".png')";
                    pa2.value=2010+i;
                }
                else if(t=='1'){
                   third.style.backgroundImage="url('../parts/circle"+i+".png')";
                   pa3.value=2010+i;
                }
            }
			...
			function check_cubic(i){
                ...
                if(f=='1'){
                    ...
                    second.style.backgroundImage="url('../parts/cubic"+i+".png')";
                    pa2.value=2020+i;
                }
                else if(t=='1'){
                   third.style.backgroundImage="url('../parts/cubic"+i+".png')";
                   pa3.value=2020+i;
                }
            }
			...
			function check_flower(i){
                ...
                if(f=='1'){
                    ...
                    second.style.backgroundImage="url('../parts/flower"+i+".png')";
                    pa2.value = 2040+i;
                }
                else if(t=='1'){
                   third.style.backgroundImage="url('../parts/flower"+i+".png')";
                   pa3.value = 2040+i;
                }
            }
			...
			function check_heart(i){
                ...
                if(f=='1'){
                    ...
                    second.style.backgroundImage="url('../parts/heart"+i+".png')";
                    pa2.value = 2050+i;
                }
                else if(t=='1'){
                   third.style.backgroundImage="url('../parts/heart"+i+".png')";
                   pa3.value = 2050+i;
                }
            }
...
<li><a href="../ready/shoppingCart.jsp">Cart</a></li>
        ...
        <h2 class="text-center">Customizing</h2>
		<br><br><br><br>
        <div id="custom3" class="text-center">
            <div class="row">
                <div id="made">
                    ...
                    <div id="second" value="0" onclick='ch2()'>
                	
                    </div>
					<div id="third_i">
						3rd
					</div>
                    <div id="third" value="0" onclick='ch3()'>
        ...
        <form action="../ready/pay_p3.jsp" method="POST" name="second">
	        <div class = "text-center">
	        	<input type="hidden" id="p_id_1" name="p_id_1" value="">
	        	<input type="hidden" id="p_id_2" name="p_id_2" value="">
	        	<input type="hidden" id="p_id_3" name="p_id_3" value="">
